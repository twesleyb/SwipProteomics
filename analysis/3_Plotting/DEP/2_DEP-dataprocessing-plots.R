...
data(swip_tmt) # the preprocessed data
data(samples) # the sample metadata
data(se_list) # the DEP processed data as list of se objects
data(fixed_gene_map); gene_map <- fixed_gene_map
