...
adjm = c(discovery=file.path(root,"rdata","adjm.csv"), test=NULL)
netw = c(discovery=file.path(root,"rdata","wt_netw.csv", test=NULL)

part = c(discovery="wt_partition.csv", test=NULL)
data = c(discovery="wt_protein.csv.csv", test=NULL)
