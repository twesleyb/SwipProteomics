function (glmfit, pcutoff = 0.1, adjust = "holm", plot = FALSE, 
...
function (fm, pcutoff = 0.1, adjust = "holm", plot = FALSE, 
    main = "qq-plot of residual deviances", ...) 
{
    stopifnot(is(fm, "lmerMod"))

    gof.stats <- fm$deviance # what is the comparable statistic?
