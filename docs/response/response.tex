...
\hlcom{## the LMM formula to be fit:}
\hlstd{fx0} \hlkwb{<-} \hlkwd{formula}\hlstd{(}\hlstr{"Abundance ~ 0 + Genotype:BioFraction + (1|Mixture)"}\hlstd{)}

\hlcom{# fit the model for WASHC4}
\hlstd{fm0} \hlkwb{<-} \hlstd{lmerTest}\hlopt{::}\hlkwd{lmer}\hlstd{(fx0, msstats_prot} \hlopt{%>%} \hlkwd{filter}\hlstd{(Protein} \hlopt{==} \hlstd{swip))}

\hlstd{model_summary} \hlkwb{<-} \hlkwd{summary}\hlstd{(fm0,} \hlkwc{ddf} \hlstd{=} \hlstr{"Satterthwaite"}\hlstd{)}

\hlstd{model_summary}\hlopt{$}\hlstd{coefficients} \hlopt{%>%} \hlstd{knitr}\hlopt{::}\hlkwd{kable}\hlstd{()}
\end{alltt}
\end{kframe}
...
\hline
GenotypeMutant:BioFractionF4 & 5.404300 & 0.121126 & 17.30594 & 44.61718 & 0\\
\hline
GenotypeControl:BioFractionF4 & 6.710959 & 0.121126 & 17.30594 & 55.40477 & 0\\
\hline
GenotypeMutant:BioFractionF5 & 5.567441 & 0.121126 & 17.30594 & 45.96405 & 0\\
\hline
GenotypeControl:BioFractionF5 & 6.945583 & 0.121126 & 17.30594 & 57.34180 & 0\\
\hline
GenotypeMutant:BioFractionF6 & 5.640188 & 0.121126 & 17.30594 & 46.56463 & 0\\
\hline
GenotypeControl:BioFractionF6 & 7.240081 & 0.121126 & 17.30594 & 59.77313 & 0\\
\hline
GenotypeMutant:BioFractionF7 & 5.631680 & 0.121126 & 17.30594 & 46.49440 & 0\\
\hline
GenotypeControl:BioFractionF7 & 7.321074 & 0.121126 & 17.30594 & 60.44180 & 0\\
\hline
GenotypeMutant:BioFractionF8 & 5.492772 & 0.121126 & 17.30594 & 45.34759 & 0\\
\hline
GenotypeControl:BioFractionF8 & 7.129632 & 0.121126 & 17.30594 & 58.86129 & 0\\
\hline
GenotypeMutant:BioFractionF9 & 5.781022 & 0.121126 & 17.30594 & 47.72734 & 0\\
\hline
GenotypeControl:BioFractionF9 & 6.954472 & 0.121126 & 17.30594 & 57.41518 & 0\\
\hline
GenotypeMutant:BioFractionF10 & 5.784403 & 0.121126 & 17.30594 & 47.75525 & 0\\
\hline
GenotypeControl:BioFractionF10 & 7.618697 & 0.121126 & 17.30594 & 62.89894 & 0\\
\hline
\end{tabular}
