...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(predvars, data, env): object 'Genotype' not found}}\begin{alltt}
\hlcom{# examine the model's summary}
\hlkwd{summary}\hlstd{(fm0,} \hlkwc{ddf} \hlstd{=} \hlstr{"Satterthwaite"}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in h(simpleError(msg, call)): error in evaluating the argument 'object' in selecting a method for function 'summary': object 'fm0' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in contrast7["{}GenotypeMutant:BioFractionF7"{}] <- +1: object 'contrast7' not found}}\begin{alltt}
\hlstd{contrast7[}\hlstr{"GenotypeControl:BioFractionF7"}\hlstd{]} \hlkwb{<-} \hlopt{-}\hlnum{1} \hlcom{# negative coeff}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in contrast7["{}GenotypeControl:BioFractionF7"{}] <- -1: object 'contrast7' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in inherits(fm, "{}lm"{}): object 'fm0' not found}}\begin{alltt}
\hlcom{# evaluate contrast}
\hlkwd{lmerTestContrast}\hlstd{(fm0, contrast8)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in stopifnot(all(names(contrast) == names(lme4::fixef(fm)))): object 'contrast8' not found}}\end{kframe}
\end{knitrout}

\paragraph{Fit WASH Complex}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in family(object): object 'fm0' not found}}\begin{alltt}
...
\hlstd{vp_fx} \hlkwb{<-} \hlstr{"Abundance ~ (1|Genotype) + (1|BioFraction) + (1|Mixture) + (1|Protein)"}
\hlstd{fit} \hlkwb{<-} \hlkwd{lmer}\hlstd{(vp_fx,} \hlkwc{data} \hlstd{= msstats_prot} \hlopt{%>%} \hlkwd{filter}\hlstd{(Protein} \hlopt{%in%} \hlstd{washc_prots))}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(predvars, data, env): object 'Genotype' not found}}\begin{alltt}
\hlkwd{calcVarPart}\hlstd{(fit)} \hlopt{%>%} \hlstd{knitr}\hlopt{::}\hlkwd{kable}\hlstd{()}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in h(simpleError(msg, call)): error in evaluating the argument 'fit' in selecting a method for function 'calcVarPart': object 'fit' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in h(simpleError(msg, call)): error in evaluating the argument 'object' in selecting a method for function 'summary': object 'fm0' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in df\$Coefficient: object of type 'closure' is not subsettable}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `colnames<-`(`*tmp*`, value = character(0)): attempt to set 'colnames' on an object with less than two dimensions}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `colnames<-`(`*tmp*`, value = character(0)): attempt to set 'colnames' on an object with less than two dimensions}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `colnames<-`(`*tmp*`, value = character(0)): attempt to set 'colnames' on an object with less than two dimensions}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in df\$"{}p value"{}: object of type 'closure' is not subsettable}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in df\$Estimate: object of type 'closure' is not subsettable}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in df\$SE: object of type 'closure' is not subsettable}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in df\$DF: object of type 'closure' is not subsettable}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in df\$"{}t value"{}: object of type 'closure' is not subsettable}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in as.vector(x, mode): cannot coerce type 'closure' to vector of type 'any'}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in is.gtable(x): object 'tab' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'nrow': object 'tab' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot\_grid(g): object 'g' not found}}\end{kframe}
\end{knitrout}
